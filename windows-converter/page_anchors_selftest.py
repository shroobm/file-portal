...
# 18 · S209 E10 (NBC): a page whose only text is a footnote that recurs later in the book, its own instance absent from the
...
# 19 · the fence holds the table path too: a table whose rows recur on a later page, its own instance absent
...
# 20 · a once-only key can stand on the WRONG page (its own instance lost, an earlier page's kept): it must neither lead nor

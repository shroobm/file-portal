...
CONV_SUITES="${FP_CONV_SUITES:-windows-converter/convert_and_ship_selftest.py windows-converter/watch_and_convert_selftest.py windows-converter/table_geometry_selftest.py windows-converter/marker_blocks_selftest.py windows-converter/degeneration_selftest.py windows-converter/analyst_selftest.py prototypes/repair-bench/test_table_boundary.py prototypes/repair-bench/test_generated_md.py windows-converter/latex_structure_selftest.py windows-converter/analyst_audit_selftest.py windows-converter/edit_whitelist_selftest.py windows-converter/blank_assets_selftest.py windows-converter/figure_coverage_selftest.py}"

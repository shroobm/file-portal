...
- **J15**, live on the close card during Fable's own close: `DEBT open SYM 4` against a real 18. The same defect shape was fixed in `open.sh` this session and its twin left in `close.sh`.

...
| J20 | **Staged exe `1CF604CD` UNADOPTED** — the live accumulator rows (slices/pages/stalls/retry-spend this run) + the 40-event tail (commit `2296cc0`). Adoption was HELD mid-run because a widget close kills the watcher tree (S37 Job Object); with the pipeline idle it is one Copy-Item + Get-FileHash away. The adopted glass is `4C6B073B` | SEMANTIC (adoption is Rab's hand — docs/19 §0.3) | `sessions/S113-fable-lane-2026-08-31.md` §2f, `Observed 2026-08-31` |

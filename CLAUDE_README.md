...
*(No session open — S29 closed 2026-07-20. Real root cause was MSIX AppData redirection, NOT the stale-frontend-embed theory the open-plan asserted; see the S29 Session Log entry for the honest correction. Widget fixed. Next: Rab signs off Survival Audit thresholds → widget projection slice + Beer remedy; optional widget-config-location hardening.)*
